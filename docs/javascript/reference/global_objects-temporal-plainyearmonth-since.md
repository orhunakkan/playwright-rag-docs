...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Temporal/PlainYearMonth/since](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Temporal/PlainYearMonth/since)
...
A new `Temporal.Duration` object representing the duration _since_ `other` to this year-month. The duration is positive if `other` is before this year-month, and negative if after.
