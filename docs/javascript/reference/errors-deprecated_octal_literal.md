...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Errors/Deprecated_octal_literal](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Errors/Deprecated_octal_literal)
...
`SyntaxError` in [strict mode](/en-US/docs/Web/JavaScript/Reference/Strict_mode) only.
