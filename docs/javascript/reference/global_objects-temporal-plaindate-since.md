...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Temporal/PlainDate/since](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Temporal/PlainDate/since)
...
A new `Temporal.Duration` object representing the duration _since_ `other` to this date. The duration is positive if `other` is before this date, and negative if after.
