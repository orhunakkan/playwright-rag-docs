...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Errors/Function_label](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Errors/Function_label)

---

The JavaScript exception "functions cannot be labelled" occurs when a `function` declaration has a [label](/en-US/docs/Web/JavaScript/Reference/Statements/label) before it.
