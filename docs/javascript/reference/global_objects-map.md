...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map)
...
<table class="standard-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Determining the number of items in an <code>Object</code> is more roundabout and less efficient. A common way to do it is through the `length` of the array returned from `Object.keys()`.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <p>
          ...
          <code>Map</code> by using `JSON.stringify()`
...
- Read-only `Map`-like objects have the property `size`, and the methods: `entries()`, `forEach()`, `get()`, `has()`, `keys()`, `values()`, and [`Symbol.iterator()`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map/Symbol.iterator).
...
- `Map.prototype[Symbol.toStringTag]`
  - : The initial value of the [`[Symbol.toStringTag]`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/toStringTag) property is the string `"Map"`. This property is used in `Object.prototype.toString()`.
