...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring)
...
For both object and array destructuring, there are two kinds of destructuring patterns: _`binding` pattern_ and _assignment pattern_, with slightly different syntaxes.
