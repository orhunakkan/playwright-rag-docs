...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Temporal/Instant/since](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Temporal/Instant/since)
...
A new `Temporal.Duration` object representing the duration _since_ `other` to this instant. The duration is positive if `other` is before this instant, and negative if after.
