...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array/fromBase64](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array/fromBase64)

---

The **`Uint8Array.fromBase64()`** static method creates a new `Uint8Array` object from a [base64](/en-US/docs/Glossary/Base64)-encoded string.
