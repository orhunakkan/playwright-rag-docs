...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/assign](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/assign)
...
- `TypeError`
  - : Thrown in one of the following cases:
    - The `target` parameter is [`null`](/en-US/docs/Web/JavaScript/Reference/Operators/null) or `undefined`.
...
> [!NOTE]
> `Object.assign()` does not throw on [`null`](/en-US/docs/Web/JavaScript/Reference/Operators/null) or `undefined` sources.
...
For [deep cloning](/en-US/docs/Glossary/Deep_copy), we need to use alternatives like `structuredClone()`, because `Object.assign()`
