...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/slice](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/slice)

---

The **`slice()`** method of `Array` instances returns a [shallow copy](/en-US/docs/Glossary/Shallow_copy) of a portion of
