...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Errors/Cyclic_object_value](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Errors/Cyclic_object_value)

---

The JavaScript exception "cyclic object value" occurs when object references were found
in [JSON](https://www.json.org/). `JSON.stringify()` doesn't try
