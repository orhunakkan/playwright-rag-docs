...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Iterator/Symbol.dispose](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Iterator/Symbol.dispose)

---

The **`[Symbol.dispose]()`** method of `Iterator` instances implements the _disposable protocol_ and allows it to be disposed when used with `using`. It calls the `return()` method of `this`, if it exists.
