...
> **Source:** [developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Numbers_and_strings](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Numbers_and_strings)
...
| `Number.isSafeInteger()` | Determines whether the provided value is a number that is a _safe integer_.                                                           |
