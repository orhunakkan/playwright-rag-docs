...
> **Source:** [playwright.dev/dotnet/docs/release-notes](https://playwright.dev/dotnet/docs/release-notes)
...
- New property [FrameLocator.Owner](/api/class-framelocator.mdx#frame-locator-owner) converts a FrameLocator object to a Locator. This can be useful when you have a FrameLocator object obtained somewhere, and later on would like to interact with the `iframe` element.
  ...
  ```csharp
  var frameLocator = page.FrameLocator("iframename='embedded'");
  // ...
...
- Role selectors that allow selecting elements by their [ARIA role](https://www.w3.org/TR/wai-aria-1.2/#roles), [ARIA attributes](https://www.w3.org/TR/wai-aria-1.2/#aria-attributes) and [accessible name](https://w3c.github.io/accname/#dfn-accessible-name).
  ...
  await page.Locator("role=buttonname='log in'").ClickAsync();
  ```
...
```csharp
await page.Locator("_react=SubmitButtonenabled=true").ClickAsync();
await page.Locator("_vue=submit-buttonenabled=true").ClickAsync();
```
