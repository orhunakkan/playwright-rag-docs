...
> **Source:** [playwright.dev/dotnet/docs/other-locators](https://playwright.dev/dotnet/docs/other-locators)
...
await page.Locator("//spancontains(@class, 'spinner__loading')|//div@id='confirmation'").WaitForAsync();
```
