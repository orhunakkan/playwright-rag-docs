...
> **Source:** [playwright.dev/dotnet/docs/network](https://playwright.dev/dotnet/docs/network)
...
Wait for Responses with [Page.RunAndWaitForResponseAsync()](/api/class-page.mdx#page-wait-for-response)
