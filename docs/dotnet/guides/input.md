...
> **Source:** [playwright.dev/dotnet/docs/input](https://playwright.dev/dotnet/docs/input)
...
Using [Locator.SetCheckedAsync()](/api/class-locator.mdx#locator-set-checked) is the easiest way to check and uncheck a checkbox or a radio button. This method can be used with `inputtype=checkbox`, `inputtype=radio` and `role=checkbox` elements.
