...
> **Source:** [playwright.dev/dotnet/docs/evaluating](https://playwright.dev/dotnet/docs/evaluating)
...
await page.EvaluateAsync("x => x.button1.textContent + x.list0.textContent + String(x.foo)", new { button1, list = new[] { button2 }, foo = null as object });
```
