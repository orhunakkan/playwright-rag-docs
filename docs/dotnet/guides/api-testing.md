...
> **Source:** [playwright.dev/dotnet/docs/api-testing](https://playwright.dev/dotnet/docs/api-testing)
...
class TestGitHubAPI : PageTest
{
    ...
    public async Task LastCreatedIssueShouldBeFirstInTheList()
    {
        ...
        var firstIssue = Page.Locator("adata-hovercard-type='issue'").First;
