...
> **Source:** [playwright.dev/dotnet/docs/webview2](https://playwright.dev/dotnet/docs/webview2)
...
var context = browser.Contexts0;
var page = context.Pages0;
```
