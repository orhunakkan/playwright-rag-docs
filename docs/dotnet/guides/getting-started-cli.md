...
> **Source:** [playwright.dev/dotnet/docs/getting-started-cli](https://playwright.dev/dotnet/docs/getting-started-cli)
...
playwright-cli click "role=buttonname=Submit"
playwright-cli click "#footer >> role=buttonname=Submit"
```
