...
> **Source:** [playwright.dev/dotnet/docs/locators](https://playwright.dev/dotnet/docs/locators)
...
:::noteWhen to use label locators
...
:::noteWhen to use placeholder locators
...
:::noteWhen to use title locators
...
:::noteWhen to use testid locators
...
await Page.Locator("//*@id='tsf'/div2/div1/div1/div/div2/input").ClickAsync();
```

:::noteWhen to use this
