...
> **Source:** [playwright.dev/dotnet/docs/api/class-framelocator](https://playwright.dev/dotnet/docs/api/class-framelocator)
...
```csharp
var frameLocator = Page.Locator("iframename=\"embedded\"").ContentFrame;
// ...
