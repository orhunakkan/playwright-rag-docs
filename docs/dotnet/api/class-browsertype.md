...
> **Source:** [playwright.dev/dotnet/docs/api/class-browsertype](https://playwright.dev/dotnet/docs/api/class-browsertype)
...
var defaultContext = browser.Contexts0;
var page = defaultContext.Pages0;
```
...
- `options` `BrowserTypeLaunchOptions?` *(optional)*
  ...
  - `IgnoreAllDefaultArgs` bool? *(optional)* 
