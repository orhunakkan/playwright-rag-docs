...
> **Source:** [playwright.dev/dotnet/docs/api/class-credentials](https://playwright.dev/dotnet/docs/api/class-credentials)
...
File.WriteAllText("playwright/.auth/passkey.json", JsonSerializer.Serialize(credentials0));
```
