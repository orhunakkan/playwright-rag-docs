...
> **Source:** [playwright.dev/java/docs/other-locators](https://playwright.dev/java/docs/other-locators)
...
page.locator("//spancontains(@class, 'spinner__loading')|//div@id='confirmation'").waitFor();
```
