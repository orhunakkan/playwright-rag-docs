...
> **Source:** [playwright.dev/java/docs/accessibility-testing](https://playwright.dev/java/docs/accessibility-testing)
...
public class HomepageTests {
  ...
  void navigationMenuFlyoutShouldNotHaveAutomaticallyDetectableAccessibilityViolations() throws Exception {
    ...
    page.locator("buttonaria-label=\"Navigation Menu\"").click();
...
public class HomepageTests {
  ...
  shouldOnlyHaveAccessibilityViolationsMatchingKnownFingerprints() throws Exception {
    ...
    assertEquals(Arrays.asList(
      new ViolationFingerprint("aria-roles", "[spanrole=\"invalid\"]"),
