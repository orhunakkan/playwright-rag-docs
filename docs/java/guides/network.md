...
> **Source:** [playwright.dev/java/docs/network](https://playwright.dev/java/docs/network)
...
Wait for Responses with [Page.waitForResponse()](/api/class-page.mdx#page-wait-for-response)
