...
> **Source:** [playwright.dev/java/docs/api-testing](https://playwright.dev/java/docs/api-testing)
...
public class TestGitHubAPI {
  ...
  void lastCreatedIssueShouldBeFirstInTheList() {
    ...
    Locator firstIssue = page.locator("adata-hovercard-type='issue'").first();
