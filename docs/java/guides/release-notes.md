...
> **Source:** [playwright.dev/java/docs/release-notes](https://playwright.dev/java/docs/release-notes)
...
- New method [Locator.contentFrame()](/api/class-locator.mdx#locator-content-frame) converts a Locator object to a FrameLocator. This can be useful when you have a Locator object obtained somewhere, and later on would like to interact with the content inside the frame.
  ...
  ```java
  Locator locator = page.locator("iframename='embedded'");
  // ...
...
- New method [FrameLocator.owner()](/api/class-framelocator.mdx#frame-locator-owner) converts a FrameLocator object to a Locator. This can be useful when you have a FrameLocator object obtained somewhere, and later on would like to interact with the `iframe` element.
  ...
  ```java
  FrameLocator frameLocator = page.frameLocator("iframename='embedded'");
  // ...
...
public class TestExample {
  ...
  void shouldSearchWiki(Page page) {
    ...
    page.locator("inputname=\"search\"").click();
    page.locator("inputname=\"search\"").fill("playwright");
    page.locator("inputname=\"search\"").press("Enter");
...
- Role selectors that allow selecting elements by their [ARIA role](https://www.w3.org/TR/wai-aria-1.2/#roles), [ARIA attributes](https://www.w3.org/TR/wai-aria-1.2/#aria-attributes) and [accessible name](https://w3c.github.io/accname/#dfn-accessible-name).
  ...
  page.locator("role=buttonname='log in'").click();
  ```
...
```java
page.locator("_react=SubmitButtonenabled=true").click();
page.locator("_vue=submit-buttonenabled=true").click();
```
