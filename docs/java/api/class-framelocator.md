...
> **Source:** [playwright.dev/java/docs/api/class-framelocator](https://playwright.dev/java/docs/api/class-framelocator)
...
```java
FrameLocator frameLocator = page.locator("iframename=\"embedded\"").contentFrame();
// ...
