...
> **Source:** [playwright.dev/java/docs/api/class-route](https://playwright.dev/java/docs/api/class-route)
...
- `options` `Route.FulfillOptions` *(optional)*
  ...
  - `setResponse` APIResponse *(optional)* 
