...
> **Source:** [playwright.dev/java/docs/api/class-websocketroute](https://playwright.dev/java/docs/api/class-websocketroute)
...
**Arguments**
- `handler` Consumer<WebSocketFrame>
