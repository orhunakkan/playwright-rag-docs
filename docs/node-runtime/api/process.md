...
> **Source:** [nodejs.org/docs/v24.18.0/api/process.html](https://nodejs.org/docs/v24.18.0/api/process.html)
...
**Added in:** v0.5.3
**Deprecated since:** v23.4.0, v22.13.0
...
**History:**
- v24.12.0: Type stripping is now stable.
