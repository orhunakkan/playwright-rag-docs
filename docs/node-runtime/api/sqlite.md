...
> **Source:** [nodejs.org/docs/v24.18.0/api/sqlite.html](https://nodejs.org/docs/v24.18.0/api/sqlite.html)
...
**Added in:** v22.5.0
**History:**
- v24.15.0: SQLite is now a release candidate.
...
**Added in:** v22.5.0
**History:**
- v24.14.0: Enable `defensive` by default.
- v24.12.0: Add `defensive` option.
- v24.4.0: Add new SQLite database options.
...
**Added in:** v24.9.0
**History:**
- v24.13.1: Changed from a method to a getter.
