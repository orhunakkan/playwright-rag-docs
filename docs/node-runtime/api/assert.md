...
> **Source:** [nodejs.org/docs/v24.18.0/api/assert.html](https://nodejs.org/docs/v24.18.0/api/assert.html)
...
**History:**
- v24.0.0: partialDeepStrictEqual is now Stable. Previously, it had been Experimental.
