...
> **Source:** [nodejs.org/docs/v24.18.0/api/n-api.html](https://nodejs.org/docs/v24.18.0/api/n-api.html)
...
**History:**
- v24.13.1: Added `napi_float16_array` for Float16Array support.
...
**N-API version:** 1
**History:**
- v24.18.0: Added support for `SharedArrayBuffer`.
...
**N-API version:** 1
**History:**
- v24.13.1: Added support for `SharedArrayBuffer`.
