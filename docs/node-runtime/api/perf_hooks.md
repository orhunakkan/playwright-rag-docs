...
> **Source:** [nodejs.org/docs/v24.18.0/api/perf_hooks.html](https://nodejs.org/docs/v24.18.0/api/perf_hooks.html)
...
**History:**
- v24.12.0: Added `perf_hooks.eventLoopUtilization` alias.
...
**Added in:** v8.5.0
**History:**
- v24.12.0: Added `perf_hooks.timerify` alias.
