...
> **Source:** [nodejs.org/docs/v24.18.0/api/module.html](https://nodejs.org/docs/v24.18.0/api/module.html)
...
**History:**
- v24.13.1: Synchronous and in-thread hooks are now release candidate.
...
**History:**
- v24.15.0: This feature is no longer experimental.
- v24.12.0: Add `portable` option to enable portable compile cache.
- v24.12.0: Rename the unreleased `path` option to `directory` to maintain consistency.
