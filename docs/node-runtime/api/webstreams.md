...
> **Source:** [nodejs.org/docs/v24.18.0/api/webstreams.html](https://nodejs.org/docs/v24.18.0/api/webstreams.html)

---

**Introduced in:** v16.5.0
...
**Added in:** v17.0.0
**History:**
- v24.7.0: format now accepts `brotli` value.
