...
> **Source:** [nodejs.org/docs/v24.18.0/api/cli.html](https://nodejs.org/docs/v24.18.0/api/cli.html)

---

**Introduced in:** v5.9.1
...
**Added in:** v20.0.0
**History:**
- v24.4.0: When spawning process with the permission model enabled. The flags are inherit to the child Node.js process through NODE_OPTIONS environment variable.
...
**Added in:** v20.0.0
**History:**
- v24.2.0: Entrypoints of your application are allowed to be read implicitly.
...
**Added in:** v18.8.0
**History:**
- v24.13.1: The snapshot building process is no longer experimental.
...
**History:**
- v24.8.0: The option is no longer experimental.
...
**History:**
- v24.13.1: The flag is no longer experimental.
...
**Added in:** v12.0.0
**History:**
- v23.6.0: Add support for `-typescript` values.
...
**Added in:** v22.0.0, v20.17.0
**History:**
- v24.15.0: The flag was renamed from `--no-experimental-require-module` to `--no-require-module`, with the former marked as legacy.
...
**Added in:** v22.0.0, v20.17.0
**History:**
- v24.15.0: This flag is no longer experimental.
- v24.15.0: This flag was renamed from `--no-experimental-require-module` to `--no-require-module`.
- v23.0.0, v22.12.0, v20.19.0: This is now false by default.
...
**Added in:** v22.6.0
**History:**
- v24.12.0: Type stripping is now stable, the flag was renamed from `--no-experimental-strip-types` to `--no-strip-types`.
...
**Added in:** v22.1.0
**History:**
- v24.15.0: This feature is no longer experimental.
