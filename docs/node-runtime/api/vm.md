...
> **Source:** [nodejs.org/docs/v24.18.0/api/vm.html](https://nodejs.org/docs/v24.18.0/api/vm.html)
...
**History:**
- v24.4.0: This is deprecated in favour of `sourceTextModule.moduleRequests`.
