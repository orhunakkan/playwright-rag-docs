...
> **Source:** [nodejs.org/docs/v24.18.0/api/crypto.html](https://nodejs.org/docs/v24.18.0/api/crypto.html)

---

**Introduced in:** v0.3.6
...
**Added in:** v11.6.0
**History:**
- v24.18.0: Added JWK format support for ML-KEM and SLH-DSA key types.
- v24.15.0: Added support for `'raw-public'`, `'raw-private'`, and `'raw-seed'` formats.
...
**History:**
- v24.18.0: Added JWK format support for ML-KEM and SLH-DSA key types.
- v24.15.0: Added support for `'raw-private'` and `'raw-seed'` formats.
- v24.6.0: Add support for ML-DSA keys.
...
**History:**
- v24.18.0: Added JWK format support for ML-KEM and SLH-DSA key types.
- v24.15.0: Added support for `'raw-public'` format.
- v24.6.0: Add support for ML-DSA keys.
- v15.12.0: The key can also be a JWK object.
- v15.0.0: The key can also be an ArrayBuffer. The encoding option was added. The key cannot contain more than 2 ** 32 - 1 bytes.
...
**History:**
- v24.18.0: Accept key data in addition to KeyObject instances.
...
**History:**
- v24.13.1: This API is no longer experimental.
...
**Added in:** v12.0.0
**History:**
- v24.16.0: Add support for Ed25519 context parameter.
