...
> **Source:** [nodejs.org/docs/v24.18.0/api/util.html](https://nodejs.org/docs/v24.18.0/api/util.html)
...
**Added in:** v0.8.0
**History:**
- v24.12.0: Add options object with modifyPrototype to conditionally modify the prototype of the deprecated object.
...
**Added in:** v21.7.0, v20.12.0
**History:**
- v24.16.0: Add support for hexadecimal colors.
- v24.2.0: Added the `'none'` format as a non-op format.
...
**History:**
- v24.0.0: Change stability index for this feature from Experimental to Stable.
