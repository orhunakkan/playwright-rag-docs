...
> **Source:** [nodejs.org/docs/v24.18.0/api/fs.html](https://nodejs.org/docs/v24.18.0/api/fs.html)
...
**Added in:** v17.0.0
**History:**
- v24.2.0: Added the `autoClose` option.
...
**Added in:** v10.0.0
**History:**
- v24.16.0: Now accepts an additional `signal` property to allow aborting the operation.
...
**Added in:** v22.0.0
**History:**
- v24.16.0: Add support for the `followSymlinks` option.
- v24.1.0: Add support for `URL` instances for `cwd` option.
- v24.0.0: Marking the API stable.
...
**Added in:** v0.5.10
**History:**
- v24.16.0: Added `throwIfNoEntry` option.
