...
> **Source:** [nodejs.org/docs/v24.18.0/api/webcrypto.html](https://nodejs.org/docs/v24.18.0/api/webcrypto.html)

---

**History:**
- v24.18.0: TurboSHAKE and KangarooTwelve algorithms are now supported.
...
- v23.5.0, v22.13.0: Algorithms `Ed25519` and `X25519` are now stable.
...
**Added in:** v15.0.0
**History:**
- v24.18.0: Added JWK format support for ML-KEM key types.
- v24.8.0: KMAC algorithms are now supported.
- v24.7.0: ML-KEM algorithms are now supported.
- v24.7.0: ChaCha20-Poly1305 algorithm is now supported.
- v24.7.0: ML-DSA algorithms are now supported.
...
**History:**
- v24.18.0: Added JWK format support for ML-KEM key types.
- v24.15.0: Importing ML-DSA and ML-KEM PKCS#8 keys without a seed is no longer supported.
- v24.8.0: KMAC algorithms are now supported.
- v24.7.0: ML-KEM algorithms are now supported.
- v24.7.0: ChaCha20-Poly1305 algorithm is now supported.
- v24.7.0: ML-DSA algorithms are now supported.
...
**Added in:** v24.7.0
**History:**
- v24.15.0: Renamed `cShakeParams.length` to `cShakeParams.outputLength`.
...
**Added in:** v24.8.0
**History:**
- v24.15.0: Renamed `kmacParams.length` to `kmacParams.outputLength`.
