...
> **Source:** [nodejs.org/docs/v24.18.0/api/stream.html](https://nodejs.org/docs/v24.18.0/api/stream.html)
...
**Added in:** v17.0.0
**History:**
- v24.14.0: Add 'type' option to specify 'bytes'.
- v24.0.0: Marking the API stable.
...
**Added in:** v17.0.0
**History:**
- v24.15.0: Added the 'readableType' option to specify the ReadableStream type. The 'type' option is deprecated.
- v24.14.0: Added the 'type' option to specify the ReadableStream type.
- v24.0.0: Marking the API stable.
