...
> **Source:** [nodejs.org/docs/v24.18.0/api/http.html](https://nodejs.org/docs/v24.18.0/api/http.html)
...
**Added in:** v0.3.4
**History:**
- v24.7.0: Add support for `agentKeepAliveTimeoutBuffer`.
...
**Added in:** v0.1.94
**History:**
- v12.0.0: The default behavior will return a 431 Request Header Fields Too Large if an HPE_HEADER_OVERFLOW error occurs.
...
**Added in:** v0.1.13
**History:**
- v24.12.0: Add optimizeEmptyRequests option.
