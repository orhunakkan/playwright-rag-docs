...
> **Source:** [nodejs.org/docs/v24.18.0/api/buffer.html](https://nodejs.org/docs/v24.18.0/api/buffer.html)
...
**Added in:** v0.11.3
**History:**
- v24.18.0: Default raised from 8192 to 65536.
...
**Added in:** v5.3.0
**History:**
- v24.13.1: supports Uint8Array as `this` value.
...
**Added in:** v8.2.0
**History:**
- v22.0.0: Value is changed to 2<sup>53</sup> - 1 on 64-bit architectures, and 2<sup>31</sup> - 1 on 32-bit architectures.
