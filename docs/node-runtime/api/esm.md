...
> **Source:** [nodejs.org/docs/v24.18.0/api/esm.html](https://nodejs.org/docs/v24.18.0/api/esm.html)
...
**History:**
- v24.0.0: This property is no longer experimental.
...
**History:**
- v24.5.0: Wasm modules no longer require the `--experimental-wasm-modules` flag.
