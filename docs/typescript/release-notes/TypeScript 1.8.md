...
> **Source:** [www.typescriptlang.org/docs/handbook/release-notes/typescript-1-8.html](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-1-8.html)
...
for (var x in a) {
  ...
  var obj = ax; // Type of obj is MyObject
}
```
