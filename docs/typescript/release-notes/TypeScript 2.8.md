...
> **Source:** [www.typescriptlang.org/docs/handbook/release-notes/typescript-2-8.html](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-2-8.html)
...
```ts
type MutableRequired<T> = { -readonly P in keyof T-?: TP }; // Remove readonly and ?
type ReadonlyPartial<T> = { +readonly P in keyof T+?: TP }; // Add readonly and ?
```
...
```ts
type Required<T> = { P in keyof T-?: TP };
```
