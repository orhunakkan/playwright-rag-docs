...
> **Source:** [www.typescriptlang.org/docs/handbook/release-notes/typescript-5-4.html](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-5-4.html)
...
Promise.all(["", ...([] as any)])
    .then((result) => {
        const head = result0;       // 5.3: any, 5.4: string
