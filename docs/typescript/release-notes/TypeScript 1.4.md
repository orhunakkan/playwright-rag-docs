...
> **Source:** [www.typescriptlang.org/docs/handbook/release-notes/typescript-1-4.html](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-1-4.html)
...
x0 = "world"; // OK
x0 = false; // Error, boolean is not string or number
```
