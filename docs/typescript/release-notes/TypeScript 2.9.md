...
> **Source:** [www.typescriptlang.org/docs/handbook/release-notes/typescript-2-9.html](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-2-9.html)
...
let n = map.length;
let x = map123; // Previously of type any (or an error with --noImplicitAny)
```
...
function getValue<T, K extends keyof T>(obj: T, key: K): TK {
  return objkey;
}
