...
> **Source:** [www.typescriptlang.org/docs/handbook/release-notes/typescript-5-0.html](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-5-0.html)
...
function bound(originalMethod: any, context: ClassMethodDecoratorContext) {
    ...
    context.addInitializer(function () {
        thismethodName = thismethodName.bind(this);
    });
}
```
...
For more details, read up on the original pull requesthttps://github.com/microsoft/TypeScript/pull/52203 and [its proposal issue](https://github.com/microsoft/TypeScript/issues/51479).
