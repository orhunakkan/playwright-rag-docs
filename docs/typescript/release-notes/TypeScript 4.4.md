...
> **Source:** [www.typescriptlang.org/docs/handbook/release-notes/typescript-4-4.html](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-4-4.html)
...
colorsred = 255;
let redVal = colorsred;
//  ^?

colorsblue = "da ba dee";
```
