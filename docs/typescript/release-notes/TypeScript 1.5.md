...
> **Source:** [www.typescriptlang.org/docs/handbook/release-notes/typescript-1-5.html](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-1-5.html)
...
function makeNode(name: string, initialNeighbor: Node): Node {
  ...
  neighborsinitialNeighbor.name = initialNeighbor;
