...
> **Source:** [www.typescriptlang.org/docs/handbook/release-notes/typescript-4-3.html](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-4-3.html)
...
function makeUnique<T>(
  ...
  for (let i = 0; i < collection.length; i++) {
    ...
    while (
      j < collection.length &&
      comparer(collectioni, collectionj + 1) === 0
    ) {
      j++;
    }
