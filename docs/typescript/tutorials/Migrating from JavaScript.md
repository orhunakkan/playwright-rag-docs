...
> **Source:** [www.typescriptlang.org/docs/handbook/migrating-from-javascript.html](https://www.typescriptlang.org/docs/handbook/migrating-from-javascript.html)
...
function myCoolFunction() {
  if (arguments.length == 2 && !Array.isArray(arguments1)) {
    var f = arguments0;
    var arr = arguments1;
    // ...
  }
