...
> **Source:** [www.typescriptlang.org/docs/handbook/2/objects.html](https://www.typescriptlang.org/docs/handbook/2/objects.html)
...
You can't set `myArray2` because the index signature is `readonly`.
...
function doStuff(values: ReadonlyArray<string>) {
  ...
  console.log(`The first value is ${values0}`);
