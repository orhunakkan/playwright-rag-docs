...
> **Source:** [www.typescriptlang.org/docs/handbook/2/mapped-types.html](https://www.typescriptlang.org/docs/handbook/2/mapped-types.html)
...
type CreateMutable<Type> = {
  -readonly Property in keyof Type: TypeProperty;
};
...
type Concrete<Type> = {
  Property in keyof Type-?: TypeProperty;
};
...
type MappedTypeWithNewProperties<Type> = {
    Properties in keyof Type as NewKeyType: TypeProperties
}
```
...
```ts twoslash
type Getters<Type> = {
    Property in keyof Type as `get${Capitalize<string & Property>}`: () => TypeProperty
};
...
type RemoveKindField<Type> = {
    Property in keyof Type as Exclude<Property, "kind">: TypeProperty
};
...
type ExtractPII<Type> = {
  Property in keyof Type: TypeProperty extends { pii: true } ? true : false;
};
