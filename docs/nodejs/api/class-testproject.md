...
Options for all tests in this project, for example [testOptions.browserName](/api/class-testoptions.mdx#test-options-browser-name). Learn more about [configuration](../test-configuration.mdx) and see available optionsTestOptions.
