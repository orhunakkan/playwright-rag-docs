...
expect(value).toHaveProperty('a.b0', 42);
...
- `keyPath` string
  ...
  Path to the property. Use dot notation `a.b` to check nested properties and indexed `a2` notation to check nested array items.
