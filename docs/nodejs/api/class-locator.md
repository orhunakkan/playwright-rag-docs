...
```js
const locator = page.locator('iframename="embedded"');
// ...
...
Returns the return value of [pageFunction](/api/class-locator.mdx#locator-evaluate-handle-option-expression) as aJSHandle, called with the matching element as a first argument, and [arg](/api/class-locator.mdx#locator-evaluate-handle-option-arg) as a second argument.
...
**Arguments**
- `options` Object *(optional)*
  - `style` string | Object<string, string | number> *(optional)* 
