...
Playwright Test comes with builtin fixtures listed below, and you can add your own fixtures as well. Playwright Test also provides optionsTestOptions to  configure [fixtures.browser](/api/class-fixtures.mdx#fixtures-browser), [fixtures.context](/api/class-fixtures.mdx#fixtures-context) and [fixtures.page](/api/class-fixtures.mdx#fixtures-page).
...
Learn how to [configure browser](../test-configuration.mdx) and see available optionsTestOptions.
...
Learn how to [configure context](../test-configuration.mdx) and see available optionsTestOptions.
