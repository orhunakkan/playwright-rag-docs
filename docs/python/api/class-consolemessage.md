...
> **Source:** [playwright.dev/python/docs/api/class-consolemessage](https://playwright.dev/python/docs/api/class-consolemessage)
...
msg.args0.json_value() # hello
msg.args1.json_value() # 42
```
...
# Deconstruct print arguments
await msg.args0.json_value() # hello
await msg.args1.json_value() # 42
```
