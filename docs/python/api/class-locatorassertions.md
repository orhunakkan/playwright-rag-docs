...
> **Source:** [playwright.dev/python/docs/api/class-locatorassertions](https://playwright.dev/python/docs/api/class-locatorassertions)
...
locator = page.locator("inputtype=number")
