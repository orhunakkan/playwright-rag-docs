...
> **Source:** [playwright.dev/python/docs/chrome-extensions](https://playwright.dev/python/docs/chrome-extensions)
...
def run(playwright: Playwright):
    ...
    if len(context.service_workers) == 0:
        ...
        service_worker = context.service_workers0
...
@pytest.fixture()
def context(playwright: Playwright) -> GeneratorBrowserContext, None, None:
...
@pytest.fixture()
def extension_id(context) -> Generatorstr, None, None:
    # for manifest v3:
    service_worker = context.service_workers0
