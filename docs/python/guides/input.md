...
> **Source:** [playwright.dev/python/docs/input](https://playwright.dev/python/docs/input)
...
Using [locator.set_checked()](/api/class-locator.mdx#locator-set-checked) is the easiest way to check and uncheck a checkbox or a radio button. This method can be used with `inputtype=checkbox`, `inputtype=radio` and `role=checkbox` elements.
