...
> **Source:** [playwright.dev/python/docs/release-notes](https://playwright.dev/python/docs/release-notes)
...
- New method [frame_locator.owner](/api/class-framelocator.mdx#frame-locator-owner) converts a FrameLocator object to a Locator. This can be useful when you have a FrameLocator object obtained somewhere, and later on would like to interact with the `iframe` element.
  ...
  ```python
  frame_locator = page.frame_locator("iframename='embedded'")
  # ...
...
```py
  # Click a button with accessible name "log in"
  await page.locator("role=buttonname='log in'").click()
  ```
