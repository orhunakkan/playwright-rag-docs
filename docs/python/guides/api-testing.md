...
> **Source:** [playwright.dev/python/docs/api-testing](https://playwright.dev/python/docs/api-testing)
...
) -> GeneratorAPIRequestContext, None, None:
    headers = {
...
def test_last_created_issue_should_be_first_in_the_list(api_request_context: APIRequestContext, page: Page) -> None:
    ...
    first_issue = page.locator("adata-hovercard-type='issue'").first
